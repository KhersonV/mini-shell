...
/*   Updated: 2025/01/06 16:10:44 by vmamoten         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	update_and_print_env(t_exec_command *command, t_info *info, char ***new_env)
{
    int i;
...
void	execute_command_with_env(t_exec_command *command, t_info *info, char **new_env)
{
    char *path;
